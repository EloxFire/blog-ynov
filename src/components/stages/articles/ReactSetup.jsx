        ...
        <div className="col-9 d-flex flex-row">
            ...
            <div className="sticky-top pt-5">
              ...
              <ul>
                ...
                <li className="mb-2" style={{listStyleType:"none"}}>
                  <ul>
                    <li><a href="#composants" className="blog-link">Les composants</a></li>
                    <li><a href="#props" className="blog-link">Les props</a></li>
                    <li><a href="#composant-exemple" className="blog-link">Exemple de composant</a></li>
                    <li><a href="#pour-ou-contre" className="blog-link">Pour ou contre ?</a></li>
                  </ul>
                </li>
          ...
          <div className="col-lg-9 col-12 p-5">
            ...
            <div className="margin-separator">
              ...
              <div className="p-4">
                <div className="mb-5">
                  <h5 id="composants">Les composants</h5>
                ...
                <div className="mb-5">
                  <h5 id="pour-ou-contre">Pour ou contre ReactJS ?</h5>
            ...
            <div className="margin-separator">
              <hr/>
              <h3 id="create-react-app">Script : create-react-app :</h3>
